...
export const popupToEditAvatar = document.querySelector('.popup_to_edit-avatar');
export const popupToVerify = document.querySelector('.popup_to_verify');
export const myId = '2724884f7dcf4512d9bc16e1';
...
export const avatarButton = document.querySelector('.profile__ToAvatarButton');
export const editSubmit = document.querySelector('.form__editSubmit');
export const editAvatar = document.querySelector('.form__editAvatar');
export const addSubmit = document.querySelector('.form__add-submit');
export const verifySubmit = document.querySelector('.form__verify');
